...
$sql = "select * from phieunhapkho  where MaPhieuNhap= ? ";
$a = [$m];
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="clear"></div> <!-- End .clear -->
			 <!-- Start Content Box -->
             <form action="updatePN.php" method='post' entype='multipart/form-data'>
			 ...
			 <tbody>
						<tr>
							...
							<td><input type="text" name="maphieunhap" value='<?php echo $dataN->MaPhieuNhap ?>' readonly></td>
						...
						<tr>
							<td>Ngày Nhập</td>
							<td><input type="date" name="ngay" value='<?php echo $dataN->NgayNhap ?>'></td>
						</tr>
						<tr>
							<td>Tổng giá </td>
